...
public static class SwCodeHelper
{
    public static (string ErrorCode, int StatusCode) ClassifySw(string sw1, string sw2)
    {
        ...
        {
            ("6A", "82") or ("6A", "83") or ("6A", "88") => ("FILE_NOT_FOUND", 404),
            ("6A", "86") or ("67", "00") or ("6B", "00") => ("INVALID_PARAMETERS", 400),
            ("6D", "00") or ("6E", "00") => ("UNSUPPORTED_COMMAND", 400),
            ("6A", "81") => ("UNSUPPORTED_COMMAND", 400),
            ("69", "82") or ("69", "85") or ("69", "88") => ("SECURITY_ERROR", 403),
            ("69", "84") or ("6A", "80") => ("INVALID_DATA", 400),
            ("6A", "84") => ("CARD_FULL", 507),
